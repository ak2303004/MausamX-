...
// Inject styles for the globe label
...
function renderForecast(fc) {
  ...
  // Group by day, pick reading closest to noon
  const days = {};
  ...
  entries.forEach((item, i) => {
    ...
    // Bar: position low and high relative to range
  ...
  try {
    ...
    data.forEach(place => {
      ...
      li.addEventListener("click", () => {
        ...
        // Rotate globe toward selected city
